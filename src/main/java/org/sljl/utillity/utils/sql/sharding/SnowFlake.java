...
import org.sljl.utillity.utils.basic.NumberUtil;

/**
 * Twitter的雪花算法
 * ！！！此工具慎用，需要统一配置管理注册中心和机器编号，除非已经清楚了解缺陷以及对业务的影响
 *
 * @author L.Y.F
...
public class SnowFlake {
    ...
    public static void main(String[] args) {
        for (int i = 0; i < 1; i++) {
            long id = SnowFlake.getInstance(2, 29).nextId();
            String id62 = NumberUtil.convert10to62(id);
            System.out.println(id + " - " + id62 + " - " + NumberUtil.convert62to10(id62));
        }
    }
